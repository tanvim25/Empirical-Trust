...
public class JavaNiceAnswerBadge {
	...
	public static void main(String args[]) throws Exception
	{
		...
		try
		{
			...
			System.out.println("Number of Users above 100 Nice Answer Badges : "+countfifteen);
			...
			System.out.println("Percentage above 100 Nice Answer Badges : "+fifteenabove+"%");
